...
(4, 23, '2012-09-14 13:00:00', 3),
(5, 24, '2012-09-14 14:00:00', 2),
(6, 25, '2012-09-14 15:00:00', 1),
(7, 26, '2012-09-14 16:00:00', 1),
...
from cd.bookings bk
JOIN 
    cd.members me ON bk.memid = me.memid
JOIN 
    cd.facilities fa ON bk.facid = fa.facid
where date(starttime) = '2012-09-14' and ((bk.memid = 0 AND fa.guestcost * (bk.slots) > 30) OR
  (bk.memid <> 0 AND fa.membercost * (bk.slots) > 30))
order by cost desc;
