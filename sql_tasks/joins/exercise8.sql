...
(8, 18, '2012-09-14 17:00:00', 2),
(0, 19, '2012-09-14 09:00:00', 3),
(1, 20, '2012-09-14 10:00:00', 2),
(2, 21, '2012-09-14 11:00:00', 1),
...
select s.member, s.facility, s.cost 
from (
  	select me.firstname|| ' ' ||me.surname as member, name as facility, 
  	case
